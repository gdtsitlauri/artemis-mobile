...
\author{George~David~Tsitlauri,~\IEEEmembership{}
  \thanks{G.~D.~Tsitlauri is with the Department of Informatics \& Telecommunications,
  University of Thessaly, Greece. E-mail: gdtsitlauri@gmail.com}}
...
service degradation five minutes before users experience visible pain points.
Evaluated against static-threshold and anomaly-detection baselines on synthetic
workloads, GUARDIAN achieves a 5.0-minute lead time with a 0.07 false-positive
rate, outperforming both baselines.
\end{abstract}
